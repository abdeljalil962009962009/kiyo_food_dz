...
const en: Dict = {
  ...
  'brand.tagline': 'Food delivery, made clear.',
  'brand.heroSubtitle': 'Choose your delivery address, see available restaurants, and review the complete price before placing a Cash on Delivery order.',
  'brand.heroFeature1Title': 'Order progress you can follow',
  'brand.heroFeature1Desc': 'See each supported stage, from restaurant confirmation through delivery.',
  'brand.heroFeature2Title': 'Approved, published restaurants',
  'brand.heroFeature2Desc': 'Customers only see restaurants approved and published by Kiyo Food.',
  'brand.heroFeature3Title': 'Price before confirmation',
  'brand.heroFeature3Desc': 'Food, delivery, and service fees are shown before you place the order.',
  'brand.heroFeature4Title': 'Cash on delivery',
  'brand.heroFeature4Desc': 'Pay in cash when you receive your order.',
  'brand.heroFeature5Title': 'Designed for Algeria',
  'brand.heroFeature5Desc': 'French, Arabic, and English with precise map-based delivery addresses.',
  'brand.heroFeature6Title': 'Help from the order screen',
  'brand.heroFeature6Desc': 'Open support directly from an order whenever you need assistance.',
  'brand.whyKiyo': 'Order with clarity',
  'brand.seoDescription': 'Food delivery in Algeria with map-confirmed addresses, clear prices, published restaurants, and Cash on Delivery.',
  ...
  'error.genericTitle': 'Action could not be completed',
  'error.genericBody': 'We could not complete this action. Check your connection and try again.',
  ...
  'checkout.placeOrderSummary': 'The server checks road distance, restaurant availability, and the complete Cash on Delivery total before the order is created.',
...
const fr: Dict = {
  'brand.name': 'Kiyo Food',
  'brand.tagline': 'La livraison de repas, en toute clarté.',
  'brand.heroSubtitle': 'Choisissez votre adresse, voyez les restaurants disponibles et vérifiez le prix complet avant de valider une commande payée à la livraison.',
  'brand.heroFeature1Title': 'Un suivi compréhensible',
  'brand.heroFeature1Desc': 'Suivez chaque étape disponible, de la confirmation du restaurant à la livraison.',
  'brand.heroFeature2Title': 'Restaurants approuvés et publiés',
  'brand.heroFeature2Desc': 'Seuls les restaurants approuvés et publiés par Kiyo Food sont visibles.',
  'brand.heroFeature3Title': 'Le prix avant confirmation',
  'brand.heroFeature3Desc': 'Les plats, la livraison et les frais de service sont affichés avant la commande.',
  'brand.heroFeature4Title': 'Paiement à la livraison',
  'brand.heroFeature4Desc': 'Payez en espèces à la réception de votre commande.',
  'brand.heroFeature5Title': 'Pensé pour l\'Algérie',
  'brand.heroFeature5Desc': 'Français, arabe et anglais avec des adresses de livraison confirmées sur la carte.',
  'brand.heroFeature6Title': 'Aide depuis la commande',
  'brand.heroFeature6Desc': 'Ouvrez l\'assistance directement depuis une commande lorsque vous en avez besoin.',
  'brand.whyKiyo': 'Commander en toute clarté',
  'brand.seoDescription': 'Livraison de repas en Algérie avec adresse confirmée sur la carte, prix clairs, restaurants publiés et paiement à la livraison.',
  ...
  'error.genericTitle': 'Action impossible pour le moment',
  'error.genericBody': "Nous n'avons pas pu terminer cette action. Vérifiez votre connexion puis réessayez.",
  ...
  'checkout.placeOrderSummary': 'Le serveur vérifie le trajet routier, la disponibilité du restaurant et le total complet à payer à la livraison avant de créer la commande.',
...
const ar: Dict = {
  'brand.name': 'كيو فود',
  'brand.tagline': 'توصيل الطعام بكل وضوح.',
  'brand.heroSubtitle': 'حدد عنوانك، وشاهد المطاعم المتاحة، وراجع السعر الكامل قبل تأكيد طلب الدفع عند التوصيل.',
  'brand.heroFeature1Title': 'متابعة واضحة للطلب',
  'brand.heroFeature1Desc': 'تابع كل مرحلة متاحة، من تأكيد المطعم إلى التوصيل.',
  'brand.heroFeature2Title': 'مطاعم معتمدة للنشر',
  'brand.heroFeature2Desc': 'لا يظهر للعملاء إلا المطاعم التي وافقت عليها كيو فود وتم نشرها.',
  'brand.heroFeature3Title': 'السعر قبل التأكيد',
  'brand.heroFeature3Desc': 'تظهر أسعار الأطباق والتوصيل ورسوم الخدمة قبل إنشاء الطلب.',
  'brand.heroFeature4Title': 'الدفع عند الاستلام',
  'brand.heroFeature4Desc': 'ادفع نقداً عند استلام طلبك.',
  'brand.heroFeature5Title': 'مصمم للجزائر',
  'brand.heroFeature5Desc': 'بالعربية والفرنسية والإنجليزية، مع عناوين توصيل دقيقة مؤكدة على الخريطة.',
  'brand.heroFeature6Title': 'دعم من صفحة الطلب',
  'brand.heroFeature6Desc': 'افتح الدعم مباشرة من أي طلب عندما تحتاج إلى المساعدة.',
  'brand.whyKiyo': 'اطلب بكل وضوح',
  'brand.seoDescription': 'توصيل الطعام في الجزائر مع عناوين مؤكدة على الخريطة، وأسعار واضحة، ومطاعم منشورة، والدفع عند التوصيل.',
  ...
  'error.genericTitle': 'تعذر إكمال العملية الآن',
  'error.genericBody': 'لم نتمكن من إكمال هذه العملية. تحقق من الاتصال ثم أعد المحاولة.',
  ...
  'checkout.placeOrderSummary': 'يتحقق الخادم من المسار الطرقي وتوفر المطعم والمبلغ الكامل للدفع عند التوصيل قبل إنشاء الطلب.',
